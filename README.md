...
- **Debugging** (12 tools)
  ...
  - [`list_logpoints`](docs/tool-reference.md#list_logpoints)
  - [`list_scripts`](docs/tool-reference.md#list_scripts)
  - [`remove_logpoint`](docs/tool-reference.md#remove_logpoint)
  - [`set_logpoint`](docs/tool-reference.md#set_logpoint)
